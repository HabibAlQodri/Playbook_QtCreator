...
public:
    ...
    void setupUi(QMainWindow *Loginscreen_Admin)
    {
        ...
        Loginscreen_Admin->resize(800, 534);
        centralwidget = new QWidget(Loginscreen_Admin);
        centralwidget->setObjectName("centralwidget");
        groupBox = new QGroupBox(centralwidget);
        groupBox->setObjectName("groupBox");
        groupBox->setGeometry(QRect(390, 100, 391, 291));
        QFont font;
        ...
        pushButton_back_admin_login->setGeometry(QRect(700, 430, 81, 21));
        QFont font1;
        ...
        label_3->setGeometry(QRect(0, -6, 381, 511));
        label_3->setPixmap(QPixmap(QString::fromUtf8(":/Resource/Image/ONLINE PLAYBOOK.2.png")));
