...
public:
    ...
    void setupUi(QMainWindow *Loginscreen_User)
    {
        ...
        Loginscreen_User->resize(800, 600);
        centralwidget = new QWidget(Loginscreen_User);
        centralwidget->setObjectName("centralwidget");
        groupBox = new QGroupBox(centralwidget);
        groupBox->setObjectName("groupBox");
        groupBox->setGeometry(QRect(330, 140, 391, 261));
        QFont font;
        ...
        label_3->setGeometry(QRect(-20, 150, 311, 191));
        label_3->setStyleSheet(QString::fromUtf8("image: url(:/Resource/Image/Login Icon_User.png);"));
        ...
        pushButton_back_user_login->setGeometry(QRect(600, 470, 141, 61));
        QFont font1;
